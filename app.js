...
while (chute!=nindigena) {
    ...
    {
        alert(`Boa ${nome}, você sabe o número indígena, ${nindigena}!! Seja bem-vindo ao nosso site!`); //Nesse caso eu adicionei um texto com uma variável dentro, para tanto ao invés de usar aspas simples se fez necessário usar a CRASE, e antes da variável usa-se o ${} com o nome da variável para ser lida dentro das chaves
        
    }
    else
    { //caso o chute não seja igual ao número indígena, executa o comando else
